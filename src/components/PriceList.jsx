import {pricing} from "../constants/index.jsx";
        ...
        <div className="flex gap-[1rem] max-lg:flex-wrap">
            {pricing.map((item) => (
                ...
                max-lg:w-full h-full px-6 bg-n-8 border border-n-6
                  rounded-[2rem] lg:w-auto even:py-14 odd:py-8 odd:my-5
                  [&>h4]:first:text-color-2 [&>h4]:even:text-color-1 [&>h4]:last:text-color-4">
                    ...
                    <div className="flex items-center h-[5rem] mb-6">
                        {item.price && (
                            <>
                                ...
                                <div className="text-[5.4rem] leading-noe font-bold">
                                    {item.price}
                                </div>
                            </>
                        )}
                    ...
                    <Button className="w-full mb-6"
                             href={item.price ? '/pricing' : 'mailto:lewstherintelamon123@gmail.com'}
